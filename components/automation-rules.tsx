      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="bg-gray-700 border-gray-600">
            <DialogHeader>
              <DialogTitle className="text-gray-50">Create Automation Rule</DialogTitle>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-gray-600 border-transparent focus:border-indigo-500 text-gray-200"
                />
              </div>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleAddRule} className="bg-indigo-500 hover:bg-indigo-600">
                Create Rule
              </Button>
            </DialogFooter>
          </DialogContent>
          ...
          {rules.map((rule) => (
            ...
            >
              <div className="flex-1">
                <div className="font-medium text-gray-50">{rule.name}</div>
