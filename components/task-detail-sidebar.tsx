...
export default function TaskDetailSidebar({
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-full sm:w-96 bg-gray-700 shadow-lg border-l border-gray-600 z-50 flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-gray-600">
        <h2 className="text-lg font-semibold text-gray-50">Task Details</h2>
        ...
        <div className="space-y-6">
            ...
            {isEditingTitle ? (
              <div className="space-y-2">
                <Input
                  ...
                  className="text-lg font-medium bg-gray-600 border-transparent focus:border-indigo-500 text-gray-50"
                />
              ...
              <div className="flex justify-between items-start">
                <h3 className="text-lg font-medium text-gray-50">{editedTask.title}</h3>
          ...
          <div>
            ...
            <Select value={editedTask.status} onValueChange={handleStatusChange}>
              <SelectTrigger className="bg-gray-600 border-transparent focus:border-indigo-500 text-gray-200">
          ...
          <div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full justify-start text-left font-normal bg-gray-600 border-transparent text-gray-200"
                >
          ...
          <div>
            ...
            {isEditingDescription ? (
              ...
              <div className="text-sm text-gray-400 bg-gray-600 p-3 rounded-md min-h-[60px]">
            ...
            <div className="space-y-2">
              {editedTask.subtasks.length === 0 ? (
                ...
                editedTask.subtasks.map((subtask) => (
                  <div key={subtask.id} className="flex items-center justify-between bg-gray-600 p-2 rounded-md">
            ...
            <div className="space-y-2">
              {editedTask.customFields.length === 0 ? (
                ...
                editedTask.customFields.map((field) => (
                  <div key={field.id} className="flex items-center justify-between bg-gray-600 p-2 rounded-md">
                    <div className="grid grid-cols-2 gap-2 flex-1 mr-2">
                      <div className="text-sm font-medium text-gray-200">{field.name}:</div>
                      <Input
                        value={field.value || ""}
      ...
      <div className="p-4 border-t border-gray-600 flex gap-2">
        <Button
          variant="outline"
          className="flex-1 border-indigo-500 text-indigo-500 hover:bg-indigo-500/10"
        ...
        <AlertDialog>
          ...
          <AlertDialogContent className="bg-gray-700 border-gray-600">
            <AlertDialogHeader>
              <AlertDialogTitle className="text-gray-50">Are you sure?</AlertDialogTitle>
              <AlertDialogDescription className="text-gray-300">
                This action cannot be undone. This will permanently delete the task and all its subtasks.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel className="bg-gray-600 border-gray-600 text-gray-200">Cancel</AlertDialogCancel>
